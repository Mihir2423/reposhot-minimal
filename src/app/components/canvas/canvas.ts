...
import { Component, ElementRef, inject, input, viewChild, effect, AfterViewInit } from '@angular/core';
...
export class Canvas implements AfterViewInit {
  ...
  private drawCanvas() {
    ...
    this.ctx.fillStyle = isDark ? colors.text : colors.text;
    const description = data.description || 'No description provided for this repository';
    const maxWidth = width - padding * 2 - 250;
